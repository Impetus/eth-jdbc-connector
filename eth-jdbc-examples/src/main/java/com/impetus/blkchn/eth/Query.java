...
public class Query 
{
    public static void main(String[] args) throws ClassNotFoundException
    {
        ...
        try
        {
            ...
            ResultSet rs = stmt.executeQuery("select count(*) as cnt, blocknumber from transaction where blocknumber > 1652349 and blocknumber < 1652354 group by blocknumber");
            while (rs.next())
            {
